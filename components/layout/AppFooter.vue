<template>
	...
	>
		...
		<div class="flex items-center flex-col gap-[16px] md:gap-[24px]">
			...
			<!-- 社群媒體連結 -->
			<div class="flex justify-center items-center gap-[24px] lg:gap-[48px]">
				<!-- Line -->
				<a href="#" aria-label="Line" class="w-[48px] h-[42px] md:w-[64px] md:h-[56px] transition-all duration-300 hover:scale-110 hover:text-green-400 group">
					<svg
						xmlns="http://www.w3.org/2000/svg"
						height="100%"
						width="100%"
						viewBox="0 0 512 512"
						class="transition-all duration-300 group-hover:fill-green-400"
					>
						<path
							fill="#ffffff"
				...
				>
					<svg
						...
						width="100%"
						viewBox="0 0 448 512"
						class="transition-all duration-300 group-hover:fill-blue-500"
					>
						<path
							fill="#ffffff"
...
import { ref } from "vue";
import ButtonCTA from "../common/Button-CTA.vue";
import MenuCTA from "../common/Menu-CTA.vue";
